...
class WayfarerPresenter extends BasePresenter {
	...
	public function renderDashboard() {
		...
		$whereInArray = [1,2,3,10,11,12];
		$test = $this->modelFactoryWrapper->modelBlocksModel()->getModelQuery()->andWhereIdIsIn($whereInArray);
		$whereModels = $test->load();
		$whereModelsArray = $test->load(true);
		dump($test->getLastSql());
		dump($whereModels, $whereModelsArray, $this->modelFactoryWrapper->modelBlocksModel()->loadAll(10), $this->modelFactoryWrapper->modelBlocksModel()->loadAll(10, true));
//			dump($this->modelFactoryWrapper->modelBlocksModel()->loadAll(50));
